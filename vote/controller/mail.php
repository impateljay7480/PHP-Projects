...
$mailid = $email;
$eno ="<a style=\"color: blue; \"><b> $epicid </b></a>";
$subject = "E-VOTE APP";
$text_message = "Hello";
$message = "Thank You For Registered In E-VOTE App.Your EPIC ID is:  ".$eno." So You Can Log In E-VOTE App And Vote Your      Party.</br>
             https://e-votebypi.000webhostapp.com ";
...
$subject = "NEW USER";
$text_message = "Hello";
$message = "New User Registered ".$mailid1."";
